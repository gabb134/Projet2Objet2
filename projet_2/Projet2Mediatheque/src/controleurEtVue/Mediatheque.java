...
public class Mediatheque extends Application {
	...
	public void start(Stage primaryStage) {
		...
		try {
			...
			RadioButton rbAuteurRealisateur = new RadioButton("auteur/r�alisateur");
			RadioButton rbMotsCles = new RadioButton("Mos cl�s");
			...
			root.setBottom(tPaneEnBas); // faire la partie pour la recherche(mot cl�s )
