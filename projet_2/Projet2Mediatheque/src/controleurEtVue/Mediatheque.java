	...
	public void start(Stage primaryStage) {
		...
		try {
			...
			//fichierSerial = new File("C:/Users/cg.marrero/Downloads/test/fichier.ser");
			 fichierSerial= new File("/Users/r.merzius/Desktop/fichier.ser");
			 FichierDeserial=new File("/Users/r.merzius/Desktop/fichier.ser");
			...
			/*********************************************
			 * GESTION PARTIE DE DROITE DE LA CONNEXION(ADH�RENT,PR�POS�,ADMIN,ETC.)
			 *********/
			...
			tabPeriodique.setText("P�iodiques");
...

		{
			...
			try {
				...
				if (booValide == true) {
					...
					// pour demarrer l'interface du pr�pos�
					...
					// il faut trouv� une fa�on pour fermer le primary stage � partir d'ici
					PrimaryStage.close();
				}
				else {
					Alert Erreur = new Alert(AlertType.ERROR);
					Erreur.setTitle("Erreur");
					Erreur.setHeaderText(null);
					Erreur.setContentText("Ce pr�pos� n'existe pas! Veillez rentrer un pr�pos� qui existe.");
					Erreur.showAndWait();
				}
			...
			if (txtFNom.getText().compareTo("") == 0) {
				...
				try {
					...
					if (booValide == true) {
						...
						Validation.setTitle("Confirmation");
						Validation.setHeaderText(null);
						Validation.setContentText("Connexion r�ussi! Bienvenue � la m�diath�que");
						Validation.showAndWait();

						// pour demarrer l'interface de l'adh�rent
						PrimaryStage.close();
						...
						Erreur.setTitle("Erreur");
						Erreur.setHeaderText(null);
						Erreur.setContentText("Cette adh�rent n'existe pas! Veuillez rentrer un adh�rent qui existe.");
						Erreur.showAndWait();
					}
			 ...
			 if (txtFTelephone.getText().compareTo("") == 0) {
				...
				try {
					...
					if (booValide == true) {
						...
						Erreur.setTitle("Erreur");
						Erreur.setHeaderText(null);
						Erreur.setContentText("Cette adh�rent n'existe pas! Veillez rentrer un adh�rent qui existe.");
						Erreur.showAndWait();
					}
	...
	public void ValidationAdherentDroite()
	{
			...
			if (rbPrenomEtNomDroite.isSelected()) {
				...
				if (txtFNomDroite.getText().compareTo("") == 0) {
					...
					Erreur.setTitle("Erreur");
					Erreur.setHeaderText(null);
					Erreur.setContentText("Vous n'avez pas tapez votre pr�nom");
					Erreur.showAndWait();
				 ...
				 if ( txtFTelephoneDroite.getText().compareTo("") == 0) {
					...
					Erreur.setTitle("Erreur");
					Erreur.setHeaderText(null);
					Erreur.setContentText("Vous n'avez pas tapez votre t�l�phone");
					Erreur.showAndWait();
